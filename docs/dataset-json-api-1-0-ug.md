...
## <a id="openapispecification">Open API Specification
...
## <a id="apiimplementations">API Implementations
...
## <a id="jsonandndjson">JSON and NDJSON
...
## <a id="usageexamples">Usage Examples
...
### <a id="readonlyapiexamples">Read-only API Examples
...
### <a id="writeupdateappenddeleteapiexamples">Write, Update, Append, Delete API Examples
...
## <a id="optionalendpointsandfeatures">Optional Endpoints and Features
...
### <a id="addingsupportformultipleenvironments">Adding Support for Multiple Environments
...
### <a id="datasetversions">Dataset Versions
...
### <a id="retrievingthedefinexml">Retrieving the Define-XML
...
## <a id="apiidentifiers">API Identifiers
...
## <a id="metadataanddataonlyflags">Metadata and Data Only Flags
...
## <a id="httpstatuscodes">HTTP Status Codes
...
## <a id="implementationnotes">Implementation Notes
