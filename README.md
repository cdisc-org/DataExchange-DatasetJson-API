...
The main purpose of *DataExchange-DatasetJson-API* is to create a draft API specification for Dataset-JSON and proof-of-concept implementations to demonstrate and test the API specification.
